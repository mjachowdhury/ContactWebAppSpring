         ...
         <table border ="1" width ="80%" align="center">
             ...
             <tr>
                 <td height="350px" valign="top">
                      <%-- Page Content Area --%>
                      <h3>User Login</h3>
                      <!--This are the condition below-->
                      <c:if test="${err!=null}">
                          <p class="error">${err}</p>
                      </c:if>
                          
                      <c:if test="${param.act eq 'lo'}"><!--here after logout parameter was act=lo then we are putting successful message from css class file -->                        
                          <p class="success">Logout Successfully! Thanks for using contact application.</p>
                      </c:if>
                      <c:if test="${param.act eq 'reg'}"><!--here after logout parameter was act=lo then we are putting successful message from css class file -->                        
